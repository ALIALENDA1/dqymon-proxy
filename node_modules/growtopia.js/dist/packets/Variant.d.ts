...
export declare class Variant {
     ...
     */
    constructor(options: VariantOptions | undefined, args: VariantArg[]);
    /**
     * Creates a new Variant class.
     * @param opts The options for the variant.
     * @param args The arguments of the Variant.
     */
    static from(opts?: VariantOptions | VariantArg, ...args: VariantArg[]): Variant;
    static toArray(data: Buffer): VariantArray[];
    /**
