    ...
    async decode() {
        ...
        for (let i = 0; i < this.meta.itemCount; i++) {
            ...
            if (this.meta.version >= 11) {
                ...
                if (this.meta.version >= 13)
                    item.flags5 = this.readI32();
                if (this.meta.version >= 14)
                    item.unknownInt1 = this.readI32();
                ...
                if (this.meta.version >= 17)
                    item.extraFlags1 = this.readI32();
                if (this.meta.version >= 18)
                    item.extraHash1 = this.readI32();
                if (this.meta.version >= 19)
                    item.unknownBytes2 = this.data.subarray(this.mempos, (this.mempos += 9));
                if (this.meta.version >= 21)
                    item.unknownShort1 = this.readI16();
            }
    ...
    async encode() {
        ...
        for (const item of this.meta.items) {
            ...
            if (this.meta.version >= 11) {
                ...
                if (this.meta.version >= 13)
                    this.writeI32(item.flags5);
                if (this.meta.version >= 14)
                    this.writeI32(item.unknownInt1);
                if (this.meta.version >= 15) {
                ...
                if (this.meta.version >= 17)
                    this.writeI32(item.extraFlags1);
                if (this.meta.version >= 18)
                    this.writeI32(item.extraHash1);
                if (this.meta.version >= 19) {
                ...
                if (this.meta.version >= 21)
                    this.writeI16(item.unknownShort1);
            }
        }
        this.mempos = 0;
    }
